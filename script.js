  ...
  function ($scope, $interval) {
    ...
    function loadLanguages() {
      ...
      $scope.txtPrebuid1Exp = [
        'Social closure and social distance have a great influence on stopping the progress of epidermis. Button 01A starts a simulation in which measures of social distance are taken, such as reducing contacts to 25%. Button 01B initiates the same simulation keeping the contacts at 75%. In case 01A the epidemic lasts for 100 days and the saturation of patients goes up to 45%, while in case 01B the epidemic lasts for about 400 days and its saturation is 10%.',
        'El confinamiento y la distancia social influye mucho en frenar el avance de la epidedmia. En el botón 01A se inicia una simulación en la que se toman medidas de distancia social, como es reducir los contactos al 25%. El botón 01B inicia la misma simulación manteniendo los contactos al 75%. En el caso 01A la epidemia dura 100 días y la saturación de enfermos pasa del 45%, mientras que en el caso 01B la epidemia dura unos 400 días y su saturación es del 10%.',
        "El confinament i la distància social influeix molt en frenar l'avanç de la epidedmia. En el botó 01A s'inicia una simulació en la qual es prenen mesures de distància social, com és reduir els contactes a l'25%. El botó 01B inicia la mateixa simulació mantenint els contactes al 75%. En el cas 01A l'epidèmia dura 100 dies i la saturació de malalts passa del 45%, mentre que en el cas 01B l'epidèmia dura uns 400 dies i la seva saturació és del 10%."
      ];
